...
export default function JobsGrid({ data }: Props) {
  ...
  return (
    <>
      {/* {Object.keys(data).map((companyName: string) => ( */}
      <div key={'one'} className={styles.companyRow}>
        <div className={styles.rowHeader}>
          <h2 className={styles.companyName}>Topics I sorta know</h2>
          <a
            href="/"
            // href={data[companyName][0].discord}
            target="_blank"
            ...
            >
              <div className={styles.cardBody}>
                <div>
                  ...
                  <p className={styles.company}>{topic.title}</p>
